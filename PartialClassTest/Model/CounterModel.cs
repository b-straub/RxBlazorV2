...
public partial class CounterModel : ObservableModel
{
    ...
    [ObservableCommand(nameof(AddCount2Async), nameof(CanAddCount2))] // error when AddCount2Async manipulates trigger
    [ObservableCommandTrigger<string>(nameof(Counter3), "ff")] // error when generic type differs from command type
